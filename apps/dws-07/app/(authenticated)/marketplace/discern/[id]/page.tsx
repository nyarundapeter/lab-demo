"use client";
// Catalogue item detail — APP.F11 (MarketplaceItemDetail) for DWS.07.M02 (Imaging & Radiology).
// A wired catalog card on /marketplace/discern navigates here.
...
export default function ImagingRadiologyDetailPage() {
  ...
  return (
    ...
    >
      <MarketplaceItemDetail
        ...
        entityId={id}
        suppressHeader={true}
        titleRowAction={{ label: "Submit Enquiry", onClick: () => router.push(`/marketplace/discern/${id}/request`) }}
