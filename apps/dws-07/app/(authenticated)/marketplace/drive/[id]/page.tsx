"use client";
// Catalogue item detail — APP.F11 (MarketplaceItemDetail) for DWS.07.M05 (Back Office).
// A wired catalog card on /marketplace/drive navigates here.
  ...
  return (
    ...
    >
      <MarketplaceItemDetail
        ...
        entityId={id}
        suppressHeader={true}
        titleRowAction={{ label: "Submit Enquiry", onClick: () => router.push(`/marketplace/drive/${id}/request`) }}
