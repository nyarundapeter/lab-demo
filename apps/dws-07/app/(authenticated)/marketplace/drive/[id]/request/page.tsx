"use client";
// Catalogue listing request — APP.F22 for DWS.07.M05 (Back Office).
...
export default function BackOfficeRequestPage() {
  ...
  function handleSuccess(requestId: string) {
    ...
    router.push(`/marketplace/drive/${id}`);
  }
  ...
  return (
    <div className="mx-auto max-w-lg py-8">
      <SubmitRequestForm
        ...
        onCancel={() => router.push(`/marketplace/drive/${id}`)}
      />
    </div>
  );
}
