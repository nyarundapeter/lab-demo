"use client";
// Catalogue listing request — APP.F22 for DWS.07.M03 (Diagnostic Procedures).
...
export default function DiagnosticProceduresRequestPage() {
  ...
  return (
    <div className="mx-auto max-w-lg py-8">
      <SubmitRequestForm
        ...
        onCancel={() => router.push(`/marketplace/design/${id}`)}
      />
    </div>
  );
}
